...
The full methodology and applications are described in the document below.
...
This work is protected under copyright. No part of this framework or its associated documents may be reproduced, distributed, modified, adapted, translated, or used in any form — commercial or non-commercial — without the **explicit prior written permission** of the author.

See `LICENSE.txt` for the full copyright notice.

---

## Contact and Permissions

For permissions, licensing inquiries, or collaboration requests, please contact the author directly via GitHub.
